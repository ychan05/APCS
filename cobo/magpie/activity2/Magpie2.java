...
public class Magpie2 {
	 ...
	 * 
	 * The current implementation priortizes the first keyword
	 * 
	 * 1. It will respond with the response for the keyword even if the whole word is not the keyword
	 */
